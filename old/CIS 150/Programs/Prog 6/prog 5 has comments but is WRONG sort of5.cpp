...
int main()
{
    ...
    */
    ...
    SwapName (newData, FullArray, stuCount);                                    //*** This function organizes the names AND prints them out!
...
int SwapName (ifstream& newData, string FullArray[FULL_ARRAY_LEN], int stuCount)
{
    ...
    while ( count < stuCount) {
            ...
            //NU!!strcpy(fstName, tempAlpha);
            
            
                for (int l = 0; l < SCORE_COLMS + 4; l++) {                             //store for (num of subject columns + 4; twice for Last
                                                                                        //and first Name, once for stuID, and another for score avg
                tempBeta = FullArray[k+1];
                
                //NU!!tempAlpha = tempAlpha.substr(0,5);
                //NU!!tempBeta = tempBeta.substr(0,5);
                
                }
                
                //cout << tempAlpha << endl << tempBeta << endl;
                
                if (tempAlpha > tempBeta) {                     
                //SU!!cout << "Another instance where its lower!" << endl;
                
                //SU!!cout << "FullArray[k] is " << FullArray[k] /*<< " FullArray[k+1] is " << FullArray[k+1] */<< endl;
                ...
                //SU!!cout << "k is at " << k << endl;
                //SU!!cout << "FullArray[k] is " << FullArray[k] /*<< " FullArray[k+1] is " << FullArray[k+1] */<< endl;
                
            }
    
    //SU!! cout << "instance " << count << " is on its way" << endl << endl;

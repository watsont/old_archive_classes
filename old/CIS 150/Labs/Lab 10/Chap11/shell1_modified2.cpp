...
int main()
{
    Distance distance1 = {2, 1750, 2};
    Distance distance2 = {2, 10, 0};
    long feet = 6002;
    long yards = 5230;
    
    Distance combDistance = AddDistance (distance1, distance2);
    Distance convertYards = ConvertYards( yards);
    Distance convertFeet = ConvertFeet ( feet);
    
    PrintDistance (combDistance, convertYards, convertFeet);
...
//        yards, and miles.
{
    ...
    cout << "Feet conversion of distance is " << endl
         ...
         << ", Yards: " << convertFeet.yards
         << ", Miles: " << convertFeet.miles << endl << endl;
    cout << "Yard conversion of distance is " << endl
         << "Feet: " << convertYards.feet
         << ", Yards: " << convertYards.yards
         << ", Miles: " << convertYards.miles << endl << endl;
}
